...
namespace livedead
{
    class Program
    {
        ...
        static bool caseSwitchCheck(string caseSwitchInput)
        {
            ...
            {
                Console.WriteLine("Your input is too long, start again");
        ...
        static bool dateInputCheck(string someDateString)
        {
            ...
            {
                Console.WriteLine("The date you have inpus is TOO short, please, try again!");
                dateInputCheck = true;
        ...
        {
            if (mmBirth == 1 || mmBirth == 3 || mmBirth == 5 || mmBirth == 7 || mmBirth == 8 || mmBirth == 10 || mmBirth == 12)
            {
                peremennaya = 31;
            }
            if (mmBirth == 4 || mmBirth == 6 || mmBirth == 9 || mmBirth == 11)
            {
                peremennaya = 30;
            }
            if (mmBirth == 2)
            ...
            if (mmBirth == 2 && yyyyBirth % 4 == 0)
            {
                peremennaya = 29;
            }
            if (mmBirth == mmLast && yyyyBirth == yyyyLast)
            {
                peremennaya = ddLast;
            }
        ...
        {
            {
                for (int i = 1; i <= ddLast; i++)
                    if (yyyyBirth == yyyyLast && mmBirth == mmLast)
                    {
                        break;
                    }
                    else
